...
${CREATE_IDAM_USER} user1a@test.com 123 ${IDAM_USER_BASE_URL} user 1a
${CREATE_IDAM_USER} user2a@test.com 123 ${IDAM_USER_BASE_URL} user 2a
${CREATE_IDAM_USER} user3a@test.com 123 ${IDAM_USER_BASE_URL} user 3a
${CREATE_IDAM_USER} user1b@test.com 123 ${IDAM_USER_BASE_URL} user 1b
${CREATE_IDAM_USER} user2b@test.com 123 ${IDAM_USER_BASE_URL} user 2b
${CREATE_IDAM_USER} user3b@test.com 123 ${IDAM_USER_BASE_URL} user 3b
${CREATE_IDAM_USER} user1c@test.com 123 ${IDAM_USER_BASE_URL} user 1c
${CREATE_IDAM_USER} user2c@test.com 123 ${IDAM_USER_BASE_URL} user 2c
${CREATE_IDAM_USER} user3c@test.com 123 ${IDAM_USER_BASE_URL} user 3c
