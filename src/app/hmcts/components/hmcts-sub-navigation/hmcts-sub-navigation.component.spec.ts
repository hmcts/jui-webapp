...
fdescribe('HmctsSubNavigationComponent: Testing Input & Outputs', () => {
    ...
    it('should show ITEMS pass data: Dataflow working ', () => {
        ...
        expect(testHostFixture.debugElement.queryAll(By.css('.hmcts-sub-navigation__item'))[0].nativeElement.innerText).toEqual('Nav item 1');
        ...
        expect(testHostFixture.debugElement.queryAll(By.css('.hmcts-sub-navigation__item'))[2].nativeElement.innerText).toEqual('Nav item 3');
    });
