...
// const { getOauth2Token } = require('./getToken');
// const  generateClientCode  = require('./getToken');
// const generateClientToken = require('getToken');
const getToken = require('./getToken');

function generateAPIRequest(method, subURL, params) {
   // const cookie='';
    const cookie = getToken.getOauth2Token();
    console.log(cookie);
    const options = {
        method,
        url: mainURL + subURL,
